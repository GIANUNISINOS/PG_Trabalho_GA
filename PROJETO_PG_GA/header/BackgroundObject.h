...
public:
	...
	void setupVertex(float width, float height) {
		...
		/*
			Aponta qual o indice do vertices_Fundo[] ser� usado para desenhar o tr��ngulo
		*/
		...
		*/
		...
		// L� o atributo de 5 em 5 floats, comecando em 0
		glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 5 * sizeof(float), (void*)0);
		glEnableVertexAttribArray(0);

		// L� o atributo de 5 em 5 floats, comecando em 3
